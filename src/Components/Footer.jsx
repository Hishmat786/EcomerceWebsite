...
const social = [
    { name: 'fb', src: 'src/assets/icons/fb.jpg' },
    { name: 'yt', src: 'src/assets/icons/youtube.jpg' },
    { name: 'insta', src: 'src/assets/icons/insta.jpg' },
    { name: 'tw', src: 'src/assets/icons/x.jpg' },
    { name: 'gmail', src: 'src/assets/icons/gmail.jpg' }
]
            ...
            <div className='flex flex-row gap-6 mt-2 justify-start space-x-6 list-none px-3 py-2 text-xl'>
                {
                    social.map((item, index) => (
                        <li key={index} className='w-8 h-8 overflow-hidden '>
                            <img src={item.src} alt=""  className='w-full h-full object-cover aspect-[3/2] mix-blend-color-burn translate transition-transform scale-105 hover:cursor-pointer'/>
                        </li>
                    ))
                }
            </div>
